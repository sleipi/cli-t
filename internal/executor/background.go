...
const (
	// DefaultBackgroundTimeout is the default timeout for EXIT NEVER entries (30s).
	DefaultBackgroundTimeout = 30000
	// DefaultPollInterval is the default polling interval for background asserts (100ms).
